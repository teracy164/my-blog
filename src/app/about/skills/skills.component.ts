...
export class SkillsComponent {
    public skills = [
        ...
        { category: 'language', name: 'PHP', level: LEVELS.NORMAL },
        ...
        { category: 'framework', name: 'Nuxt3', level: LEVELS.GOOD },
        { category: 'framework', name: 'Laravel', level: LEVELS.NORMAL },
        ...
        { category: 'ui-component', name: 'ElementPlus', level: LEVELS.GOOD },
        { category: 'ui-component', name: 'Vuetify', level: LEVELS.NORMAL },
        { category: 'ui-component', name: 'Angular Material', level: LEVELS.HOBBY },
        { category: 'infra', name: 'AWS ECS', level: LEVELS.NORMAL },
        { category: 'infra', name: 'AWS WAF', level: LEVELS.HAVE_EXPERIENCE },
        { category: 'infra', name: 'AWS CloudFront', level: LEVELS.NORMAL },
        ...
        { category: 'infra', name: 'AWS IAM', level: LEVELS.HAVE_EXPERIENCE },
        { category: 'infra', name: 'AWS ELB', level: LEVELS.HAVE_EXPERIENCE },
        { category: 'infra', name: 'AWS Athene', level: LEVELS.HAVE_EXPERIENCE },
        { category: 'infra', name: 'AWS Cognito', level: LEVELS.HAVE_EXPERIENCE },
        { category: 'infra', name: 'AWS SecretManager', level: LEVELS.HAVE_EXPERIENCE },
        ...
        { category: 'infra', name: 'docker', level: LEVELS.NORMAL },
        { category: 'infra', name: 'docker-compose', level: LEVELS.NORMAL },
        { category: 'infra', name: 'VirtualBOX', level: LEVELS.HAVE_EXPERIENCE },
        { category: 'infra', name: 'vagrant', level: LEVELS.HAVE_EXPERIENCE },
        { category: 'infra', name: 'WSL2', level: LEVELS.NORMAL },
